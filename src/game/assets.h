...
const char* asset_list[] = {
    ...
    "start_textures",
    ASSET_PATH "art/lamp_c.crn",
    ASSET_PATH "art/dry_fountain_c.crn",
    ASSET_PATH "art/flowerbox_c.crn",
    ASSET_PATH "art/garden_tall_corner_c.crn",
    ASSET_PATH "art/garden_tall_nook_c.crn",
    ASSET_PATH "art/garden_tall_stairs.crn",
    ASSET_PATH "art/garden_tall_wall_c.crn",
    ASSET_PATH "art/short_wall_c.crn",
    ASSET_PATH "art/tree_c.crn",
    ASSET_PATH "art/wall_pillar_c.crn",
    ASSET_PATH "art/tiling_cobbles_c.crn",
    ASSET_PATH "art/tiling_cobbles_2_c.crn",
    ASSET_PATH "art/tiling_cobbles_3_c.crn",
    ASSET_PATH "art/tiling_stain.crn",
    ASSET_PATH "art/tiling_manhole.crn",
    ASSET_PATH "art/tiling_grate.crn",
    ASSET_PATH "art/main_character_c.crn",
    ASSET_PATH "art/woman_npc_c.crn",
    ASSET_PATH "art/woman_npc_2_c.crn",
    ASSET_PATH "art/man_npc_c.crn",
    ASSET_PATH "art/man_npc_2.crn",
    ASSET_PATH "art/lampshadow.crn",
    "end_textures",
    "start_fonts",
